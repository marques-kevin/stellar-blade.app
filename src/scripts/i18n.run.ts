    ...
    messages: [
      {
        ...
        The translation is for a Spotify-like music app for Stellar Blade. I'll give you the key of the translation so use it for context.

        The chinese name of Stellar Blade is 剑星.

        The japanese name of Stellar Blade is ステラーブレイド.

        The korean name of Stellar Blade is 스텔라 블레이드.
